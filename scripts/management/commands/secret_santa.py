...
class Command(BaseCommand):
    ...
    def swap_pair(random_list, user_index):
        ...
        if user_swap_index == user_index:
            if user_swap_index != len(random_list) - 1:
                ...
                user_swap_index -= 1
        random_list[user_index], random_list[user_swap_index] = random_list[user_swap_index], random_list[user_index]
        return random_list
    ...
    def send_mail(user_to, user_from):
        ...
        content = render_to_string(
            ...
            {"user_to": user_to.user.get_full_name(), "mail_committee": settings.EMAIL_TRIKOM},
        )
    ...
    def write_to_file(to_from_dict):
        ...
        content = render_to_string("secret_santa/to_from_list.txt", {"to_from_dict": to_from_dict})
