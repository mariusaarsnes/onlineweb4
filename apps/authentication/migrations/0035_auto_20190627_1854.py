    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description_short",
                    models.TextField(blank=True, max_length=2048, verbose_name="Beskrivelse (kortfattet)"),
                ),
                (
                    "description_long",
                    models.TextField(blank=True, max_length=2048, verbose_name="Beskrivelse (helhetlig)"),
                ),
        ...
        migrations.AlterUniqueTogether(name="grouprole", unique_together={("membership", "role_type")}),
        migrations.AlterUniqueTogether(name="groupmember", unique_together={("user", "group")}),
    ]
