    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ntnu_username",
                    models.CharField(max_length=10, unique=True, null=True, verbose_name="NTNU-brukernavn", blank=True),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(related_name="email_user", to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(related_name="positions", to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        related_name="register_user", to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        related_name="special_positions", to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
