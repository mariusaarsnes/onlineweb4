...
class SignupAPIURLTestCase(APITestCase):
    def setUp(self) -> None:
        super().setUp()
        self.create_user_data = {"username": "testuser133", "email": "test33@example.org", "password": "12345678"}
    ...
    def post_url(self, url, data={}):
        return self.client.post(reverse(url), data, **{"format": "json", "Content-Type": "application/json"})
