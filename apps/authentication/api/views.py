...
class OnlineGroupViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response({"message": "Du har ikke tillatelse til å opprette grupper"}, status=status.HTTP_403_FORBIDDEN)
...
class GroupMemberViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": "Du har ikke tillatelse til å opprette gruppemedlemskap"}, status=status.HTTP_403_FORBIDDEN
        )
