...
def _handle_poster_add(request, form, order_type):
    ...
    GroupObjectPermission.objects.assign_perm("view_poster_order", Group.objects.get(name="proKom"), poster)
    GroupObjectPermission.objects.assign_perm("view_poster_order", ordered_committee, poster)
