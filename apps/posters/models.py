...
class OrderMixin(models.Model):
    ...
    ordered_by = models.ForeignKey(
        User, verbose_name=_("bestilt av"), related_name="ordered_by", on_delete=models.CASCADE
    )
    ordered_committee = models.ForeignKey(
        Group, verbose_name=_("bestilt av komite"), related_name="ordered_committee", on_delete=models.CASCADE
    )
