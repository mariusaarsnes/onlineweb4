    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price",
                    models.DecimalField(null=True, verbose_name="pris", max_digits=10, decimal_places=2, blank=True),
                ),
                ...
                (
                    "event",
                    models.ForeignKey(
                        related_name="Arrangement", blank=True, to="events.Event", null=True, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
