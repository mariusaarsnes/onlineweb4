...
class Migration(migrations.Migration):
    ...
    dependencies = [migrations.swappable_dependency(settings.AUTH_USER_MODEL), ("contenttypes", "0001_initial")]
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="feedbacks", null=True, to=settings.AUTH_USER_MODEL, blank=True
                    ),
                ),
                ...
                (
                    "feedback",
                    models.ForeignKey(
                        verbose_name="Tilbakemeldingskjema", to="feedback.Feedback", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feedback_relation",
                    models.ForeignKey(
                        related_name="field_of_study_answers", to="feedback.FeedbackRelation", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={"permissions": (("view_fieldofstudyanswer", "View FieldOfStudyAnswer"),)},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feedback_relation",
                    models.ForeignKey(
                        related_name="multiple_choice_answers", to="feedback.FeedbackRelation", on_delete=models.CASCADE
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feedback",
                    models.ForeignKey(
                        related_name="multiple_choice_questions", to="feedback.Feedback", on_delete=models.CASCADE
                    ),
                ),
                (
                    "multiple_choice_relation",
                    models.ForeignKey(to="feedback.MultipleChoiceQuestion", on_delete=models.CASCADE),
                ),
            ],
            options={"permissions": (("view_multiplechoicerelation", "View MultipleChoiceRelation"),)},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="RatingAnswer",
            fields=[
                ...
                (
                    ...
                    models.SmallIntegerField(
                        ...
                        choices=[(1, b"1"), (2, b"2"), (3, b"3"), (4, b"4"), (5, b"5"), (6, b"6")],
                    ),
                ),
                (
                    "feedback_relation",
                    models.ForeignKey(
                        related_name="rating_answers", to="feedback.FeedbackRelation", on_delete=models.CASCADE
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feedback",
                    models.ForeignKey(
                        related_name="rating_questions", to="feedback.Feedback", on_delete=models.CASCADE
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fbr",
                    models.ForeignKey(
                        related_name="Feedback_relation", to="feedback.FeedbackRelation", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={"permissions": (("view_feedbackregistertoken", "View FeedbackRegisterToken"),)},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="TextAnswer",
            fields=[
                ...
                (
                    "feedback_relation",
                    models.ForeignKey(
                        related_name="text_answers", to="feedback.FeedbackRelation", on_delete=models.CASCADE
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "feedback",
                    models.ForeignKey(related_name="text_questions", to="feedback.Feedback", on_delete=models.CASCADE),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="answer", to="feedback.MultipleChoiceRelation", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name="feedbackrelation", unique_together=set([("feedback", "content_type", "object_id")])
        ),
        migrations.AddField(
            model_name="choice",
            name="question",
            field=models.ForeignKey(
                related_name="choices", to="feedback.MultipleChoiceQuestion", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
    ]
