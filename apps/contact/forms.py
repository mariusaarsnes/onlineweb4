...
class ContactForm(forms.Form):
    ...
    contact_name = forms.CharField(required=False, widget=forms.TextInput({"placeholder": "Navn", "required": True}))
    contact_email = forms.EmailField(
        required=False, widget=forms.EmailInput({"placeholder": "Epostadresse", "required": True})
    )
