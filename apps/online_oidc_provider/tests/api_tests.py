...
from oidc_provider.models import CLIENT_TYPE_CHOICES, RESPONSE_TYPE_CHOICES, Client, ResponseType, UserConsent
...
class ClientsTest(OIDCTestCase):
    ...
    def test_user_can_update_client(self):
        ...
        response = self.client.patch(self.id_url(client.id), data={"name": client_name_other}, **self.headers)
