...
from oidc_provider.models import CLIENT_TYPE_CHOICES, RESPONSE_TYPE_CHOICES, Client, ResponseType, Token
...
class OIDCTestCase(TestCase):
    ...
    def generate_access_token(self, user, client_id="123", refresh_token="456", _scope="openid profile"):
        ...
        oidc_client = Client.objects.create(
            client_type=CLIENT_TYPE_CHOICES[1], client_id=client_id, _redirect_uris="http://localhost"
        )
