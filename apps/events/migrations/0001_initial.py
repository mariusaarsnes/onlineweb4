...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={"ordering": ["timestamp"], "permissions": (("view_attendee", "View Attendee"),)},
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name="CompanyEvent",
            fields=[
                ...
                (
                    "company",
                    models.ForeignKey(verbose_name="bedrifter", to="companyprofile.Company", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    filebrowser.fields.FileBrowseField(max_length=200, null=True, verbose_name="bilde", blank=True),
                ),
                (
                    "event_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attendance_event",
                    models.OneToOneField(
                        related_name="reserved_seats", to="events.AttendanceEvent", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reservation",
                    models.ForeignKey(related_name="reservees", to="events.Reservation", on_delete=models.CASCADE),
                ),
            ],
            options={
                "ordering": ["id"],
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=0, help_text="utsettelse oppgis i timer", verbose_name="utsettelse"
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            options={"permissions": (("view_fieldofstudyrule", "View FieldOfStudyRule"),)},
            bases=("events.rule",),
        ),
        migrations.CreateModel(
            name="RuleBundle",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="companies", verbose_name="arrangement", to="events.Event", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(name="attendee", unique_together=set([("event", "user")])),
        migrations.AddField(
