...
urlpatterns = [
    ...
    url(r"^(?P<event_id>\d+)/add_company/$", views.AddCompanyEventView.as_view(), name="dashboard_events_add_company"),
    url(
    ...
    url(r"^(?P<event_id>\d+)/add_payment/$", views.AddPaymentView.as_view(), name="dashboard_events_add_payment"),
    url(
