...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name="careeropportunity", name="end", field=models.DateTimeField(verbose_name="aktiv til")
        ),
        migrations.AlterField(
            model_name="careeropportunity", name="start", field=models.DateTimeField(verbose_name="aktiv fra")
        ),
    ]
