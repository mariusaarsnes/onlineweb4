...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name="orderline", options={"permissions": (("view_order_line", "View Order Line"),)}
        ),
        migrations.AlterModelOptions(
            name="product",
            options={
        ...
        migrations.AddField(model_name="orderline", name="delivered", field=models.BooleanField(default=False)),
    ]
