    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category",
                    models.ForeignKey(related_name="products", to="webshop.Category", on_delete=models.CASCADE),
                ),
            ],
        ...
        migrations.AddField(
            model_name="order", name="product", field=models.ForeignKey(to="webshop.Product", on_delete=models.CASCADE)
        ),
        migrations.AddField(
            model_name="order",
            name="size",
