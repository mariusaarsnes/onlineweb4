    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="article_tags", verbose_name="tag", to="article.Tag", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(name="articletag", unique_together=set([("article", "tag")])),
    ]
