...
class DataProcessingTestCase(TestCase):
    ...
    def test_get_bachelor_year_2nd_grader(self):
        groups = [load_course(ITGK_EXPIRED, years_ago=1), load_course(PROJECT1_ACTIVE, years_ago=0)]

        self.assertEqual(2, get_bachelor_year(groups))

    @freeze_time("2010-10-01 12:00")
    def test_get_bachelor_year_3rd_grader_fall(self):
        groups = [load_course(ITGK_EXPIRED, years_ago=2), load_course(PROJECT1_EXPIRED, years_ago=1)]
    ...
    def test_get_year_2nd_grader_fall(self):
        groups = [INFORMATICS_BACHELOR_STUDY_PROGRAMME, load_course(ITGK_EXPIRED, years_ago=1)]

        self.assertEqual(2, get_year(GROUP_IDENTIFIERS["BACHELOR"], groups))

    @freeze_time("2010-10-01 12:00")
    def test_get_year_3rd_grader_fall(self):
        groups = [INFORMATICS_BACHELOR_STUDY_PROGRAMME, load_course(ITGK_EXPIRED, years_ago=2)]
    ...
    def test_get_year_5th_grader_fall(self):
        groups = [INFORMATICS_MASTER_STUDY_PROGRAMME, load_course(PVS_ACTIVE, active=True)]
