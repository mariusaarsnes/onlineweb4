    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.SmallIntegerField(
                default=0, verbose_name="stripe key", choices=[(0, b"Arrkom"), (1, b"Prokom")]
            ),
        ...
        migrations.AlterUniqueTogether(name="payment", unique_together=set([("content_type", "object_id")])),
        migrations.RemoveField(model_name="payment", name="price"),
        migrations.AlterUniqueTogether(name="paymentdelay", unique_together=set([("payment", "user")])),
    ]
