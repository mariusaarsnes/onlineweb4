        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="profil synlig for andre brukere"),
                ),
                ...
                (
                    "user",
                    models.ForeignKey(
                        related_name="privacy", to=settings.AUTH_USER_MODEL, unique=True, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
