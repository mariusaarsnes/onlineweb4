    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.SmallIntegerField(
                        choices=[(1, "1. prioritet"), (2, "2. prioritet"), (3, "3. prioritet")],
                ...
                (
                    "group",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="auth.Group", verbose_name="komite"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="approval.CommitteePriority", to="auth.Group", verbose_name="komiteer"
            ),
        ),
    ]
